...
public class GabrielScript : MonoBehaviour
{
	...
	void Update ()
	{
		...
		{
			GameObject ShelfBitch = GameObject.Instantiate (AAAAAAAAAAA, base.transform.position + Vector3.up * 5f, base.transform.rotation);
		}
